...
- [x] **DRAFT-02**: Engine can compare consistency across multiple revisions of a longer draft.
...
- [x] **CHECK-01**: User can run consistency checks against an explicit approved scope, including full approved draft, chapter, or segment range.
- [x] **DIFF-01**: User can compare verdict output between runs or revisions with added, resolved, persisted, and changed findings labeled by scope.
